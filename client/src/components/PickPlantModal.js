...
import { FilterPlantCategories } from '../pages/MyPlantCollections';
import FilterPlantCollection from './FilterPlantCollection';
...
const PickPlantModal = ({isOpen: open, closeModal1, setToTrade}) => {
    ...
    <Transition appear show={open} as={Fragment}>
        ...
        >
            ...
            <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                    <Dialog.Panel className="w-full max-w-5xl min-h-[100px] transform overflow-hidden rounded-2xl bg-white py-5
                    text-left align-middle shadow-xl transition-all">
                    <div>
                        <div className='px-4'>
                            <h1 className='text-xl font-semibold mt-1 text-gray-700'>Pick your plant</h1>
                            <p className='text-xs text-gray-500'>You can select a plant into your collections.</p>
                        </div>

                        <div className='transition-all z-20 block sticky top-0 w-full h-max px-4 py-4 mt-4 border-y border-gray-200 shadow'>
                            <div className='flex items-center font-normal'>
                                {/* <h1 className='text-xl font-bold text-gray-700 mr-auto'>
                                    <span className='text-gray-500 text-xs font-normal block'>Total plants</span>
