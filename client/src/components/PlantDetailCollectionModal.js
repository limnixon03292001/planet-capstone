    ...
    return (
        <Transition appear show={isOpen} as={Fragment}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                    <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-3 
                    text-left align-middle shadow-xl transition-all h-full max-h-[558px] overflow-y-auto">
                    <Dialog.Title
                        as="h3"
                    ...
                    >   
                        ...
                        <div> 
                            <div className='flex items-start justify-start'>
                                ...
                                className='w-20 h-20 object-center object-cover rounded-full mb-3 text-white bg-emerald-300 mr-4 inline-block flex-shrink-0'/>
                                <div>
                            ...
                            <div className='flex flex-wrap flex-row items-start justify-start mt-4 text-left py-2 border-y border-gray-200'>   
                                <div className='flex-1 text-sm'>
                                    <div className='px-2'>
                                        <p className='text-base sm:text-lg font-bold mb-2 md:text-center'>Growing Preference</p>
                                ...
                                <div className='flex-1 text-sm sm:border-l sm:border-gray-200 '>
                                    <div className='px-2'>
                                        <p className='text-base sm:text-lg font-bold mb-2 md:text-center'>Growing Information</p>
