    ...
    <>
      {!checkToken() ? (
        <>
          {popUpErrNotVer && (
            <div
              className="text-yellow-700 bg-yellow-500/30 border-2 border-yellow-500 rounded-lg p-2 my-3
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <svg
                    ...
                    onClick={() => setPopUpErrNotVer(false)}
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                <p className="text-xs mt-1 text-ellipsis">
                  We noticed your account's email has not been verified. You can
                  check your email to see the verification link that we've sent.
                </p>
              </div>
            </div>
          )}
          {popUpErrBlocked && (
            <div
              className="text-red-700 bg-red-500/30 border-2 border-red-500 rounded-lg p-2 my-3
            text-sm flex items-center justify-center gap-x-3"
            >
              <div>
                <svg
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <svg
                    ...
                    stroke="currentColor"
                    className="w-4 h-4 cursor-pointer"
                    onClick={() => setPopUpErrBlocked(false)}
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                <p className="text-xs mt-1 text-ellipsis">
                  It seems like your account has been blocked!
                </p>
              </div>
            </div>
          )}
          {
            ...
            attempt !== 3 ? (
              <form onSubmit={formik.handleSubmit}>
                <div className="mb-5">
                  <label htmlFor="email" className="block text-[#536471] mb-3">
                    Email address
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-7">
                  <label
                    htmlFor="password"
                    className="block text-[#536471] mb-3"
                  >
                    Password
                  </label>
                  <input
                ...
                {isLoading ? (
                  ...
                  <button
                    type="submit"
                    className="bg-[#3DDAB4] text-white px-5 py-3 w-full rounded-full
                focus:outline-none focus:ring-4 focus:ring-green-100"
                  >
                    Login
                  </button>
                ...
                <Link
                  to="/register"
                  className="mt-3 text-xs font-light text-center block w-full underline text-blue-500"
                >
              ...
              <div className="flex items-start justify-start text-red-400">
                ...
                <p className="ml-1">
                  Too many attempts! Login has been disabled for {countDown}{" "}
                  seconds.
                </p>
              </div>
            )
