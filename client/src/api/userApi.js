...
export const searchUser = ({ queryKey }) => {
  ...
  return request({
    url: `/api/users/search?searchText=${searchText}`,
    method: "GET",
  });
};
...
export const getIsFollowingUser = ({ queryKey }) => {
  const userId = queryKey[1];
  return request({
    url: `/api/users/isfollowing-user?userId=${userId}`,
    method: "GET",
  });
};
...
export const getSpecificUserPost = ({ pageParam = 1, user_id }) => {
  return request({
    url: `/api/users/post-user?page=${pageParam}&user_id=${user_id}`,
    method: "GET",
  });
};
...
export const getCommentPost = ({ queryKey }) => {
  ...
  return request({
    url: `/api/users/getcomment?post_id=${post_id}`,
    method: "GET",
  });
};
...
export const getSelectedRoom = ({ queryKey }) => {
  const id = queryKey[1];
  return request({
    url: `/api/chats/getchatroom?chatroom_id=${id}`,
    method: "GET",
  });
};
...
export const getMessagesRoom = ({ queryKey }) => {
  const id = queryKey[1];
  return request({
    url: `/api/chats/all-messages?chatroom_id=${id}`,
    method: "GET",
  });
};
...
export const addPlantCollection = (data) => {
  return request({
    url: "/api/users/addPlantCollection",
    method: "POST",
    data: data,
  });
};
...
export const getPlantCollection = ({ queryKey }) => {
  const id = queryKey[1];
  return request({
    url: `/api/users/getPlantCollections?userId=${id}`,
    method: "GET",
  });
};
...
export const filterPlantCollections = ({ queryKey }) => {
  ...
  return request({
    url: `/api/users/filterPlantCollections?&userId=${id}&category=${category}&search=${searchData}&sunPref=${gp?.sunPref}&interLight=${gp?.interLight}&soilPref=${gp?.soilPref}&waterReq=${gp?.waterReq}&nativeHab=${gp?.nativeHab}`,
    method: "GET",
  });
};
...
export const updatePlantMarketplace = (data) => {
  return request({
    url: "/api/marketplace/updatePlant",
    method: "POST",
    data: data,
  });
};
...
export const deletePlantMarketplace = (data) => {
  return request({
    url: "/api/marketplace/deletePlant",
    method: "DELETE",
    data: data,
  });
};
...
export const addPlantMarketplaceFromCollection = (data) => {
  return request({
    url: "/api/marketplace/addPlantFromCollection",
    method: "POST",
    data: data,
  });
};
...
export const getSellingUserPlants = () => {
  return request({
    url: `/api/marketplace/getSellingUserPlants`,
    method: "GET",
  });
};
...
export const getRelatedPlants = ({ queryKey }) => {
  ...
  return request({
    url: `/api/marketplace/getRelatedPlants?category=${category}&plantId=${plantId}`,
    method: "GET",
  });
};
...
export const getPlantsUser = ({ queryKey }) => {
  const id = queryKey[1];
  return request({
    url: `/api/marketplace/getPlantsUser?userId=${id}`,
    method: "GET",
  });
};
...
export const getfilterPlantMarketplace = ({ queryKey }) => {
  ...
  return request({
    url: `/api/marketplace/filterPlantMarketplace?&category=${category}&search=${search}`,
    method: "GET",
  });
};
