...
const AddAdmin = () => {
  ...
  return (
    ...
    <div className="w-full max-w-[800px] m-auto">
        ...
        <h1 className="font-bold text-3xl mb-8 ml-3">Add Administrator account</h1>
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            {isLoading ?  <ButtonLoader 
                ...
                focus:outline-none focus:ring-4 focus:ring-green-100">Create account</button>
            }
        </form>
    </div>
</div>
